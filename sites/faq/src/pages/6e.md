...
> Verified on Rakudo **v2026.07** (MoarVM) and Raku++ **v3.5.1+**, against
...
> Where the two engines differ, §12 says so.
...
scores each from those outputs rather than from a claim. As of this writing it
reads **50 of 51 full, 0 divergent, 0 partial, 1 not implemented**, with 46 of
them gated on the pragma.
...
- **`.succ` string ranges** are 6.e's behaviour under *both* revisions here.
  ...
  per-position cross product — `("az".."bc")` is 52 elements there — which this
