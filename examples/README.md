...
| [`algorithm-dawkinsweasel/`](algorithm-dawkinsweasel/) | [Algorithm::DawkinsWeasel](https://raku.online/modules/algorithm-dawkinsweasel/) | `rakupp install Algorithm::DawkinsWeasel` |
| [`algorithm-elo/`](algorithm-elo/) | [Algorithm::Elo](https://raku.online/modules/algorithm-elo/) | `rakupp install Algorithm::Elo` |
| [`algorithm-genetic/`](algorithm-genetic/) | [Algorithm::Genetic](https://raku.online/modules/algorithm-genetic/) | `rakupp install Algorithm::Genetic` |
...
| [`algorithmsit/`](algorithmsit/) | [AlgorithmsIT](https://raku.online/modules/algorithmsit/) | `rakupp install AlgorithmsIT` |
| [`allow-no/`](allow-no/) | [allow-no](https://raku.online/modules/allow-no/) | `rakupp install allow-no` |
| [`app-rakus/`](app-rakus/) | [App::Rakus](https://raku.online/modules/app-rakus/) | `rakupp install App::Rakus` |
| [`as-cli-arguments/`](as-cli-arguments/) | [as-cli-arguments](https://raku.online/modules/as-cli-arguments/) | `rakupp install as-cli-arguments` |
...
| [`avolution-emoji/`](avolution-emoji/) | [Avolution::Emoji](https://raku.online/modules/avolution-emoji/) | `rakupp install Avolution::Emoji` |
...
| [`brazilian-federaldocuments/`](brazilian-federaldocuments/) | [Brazilian::FederalDocuments](https://raku.online/modules/brazilian-federaldocuments/) | `rakupp install Brazilian::FederalDocuments` |
...
| [`data-geographics/`](data-geographics/) | [Data::Geographics](https://raku.online/modules/data-geographics/) | `rakupp install Data::Geographics` |
| [`data-ical/`](data-ical/) | [Data::ICal](https://raku.online/modules/data-ical/) | `rakupp install Data::ICal` |
| [`data-randomkeep/`](data-randomkeep/) | [Data::RandomKeep](https://raku.online/modules/data-randomkeep/) | `rakupp install Data::RandomKeep` |
...
| [`data-tree/`](data-tree/) | [Data::Tree](https://raku.online/modules/data-tree/) | `rakupp install Data::Tree` |
| [`data-typesystem/`](data-typesystem/) | [Data::TypeSystem](https://raku.online/modules/data-typesystem/) | `rakupp install Data::TypeSystem` |
| [`date-calendar-armenian/`](date-calendar-armenian/) | [Date::Calendar::Armenian](https://raku.online/modules/date-calendar-armenian/) | `rakupp install Date::Calendar::Armenian` |
...
| [`date-calendar-mayaaztec/`](date-calendar-mayaaztec/) | [Date::Calendar::MayaAztec](https://raku.online/modules/date-calendar-mayaaztec/) | `rakupp install Date::Calendar::MayaAztec` |
...
| [`datetime-location/`](datetime-location/) | [DateTime::Location](https://raku.online/modules/datetime-location/) | `rakupp install DateTime::Location` |
...
| [`dfm-parser/`](dfm-parser/) | [DFM::Parser](https://raku.online/modules/dfm-parser/) | `rakupp install DFM::Parser` |
| [`dictionary-create/`](dictionary-create/) | [Dictionary::Create](https://raku.online/modules/dictionary-create/) | `rakupp install Dictionary::Create` |
...
| [`dirsofinterest/`](dirsofinterest/) | [DirsOfInterest](https://raku.online/modules/dirsofinterest/) | `rakupp install DirsOfInterest` |
...
| [`encoding-huffman-pp6/`](encoding-huffman-pp6/) | [Encoding::Huffman::PP6](https://raku.online/modules/encoding-huffman-pp6/) | `rakupp install Encoding::Huffman::PP6` |
...
| [`head-skip-tail/`](head-skip-tail/) | [head-skip-tail](https://raku.online/modules/head-skip-tail/) | `rakupp install head-skip-tail` |
...
| [`html-escapeutils/`](html-escapeutils/) | [HTML::EscapeUtils](https://raku.online/modules/html-escapeutils/) | `rakupp install HTML::EscapeUtils` |
| [`html-lazy/`](html-lazy/) | [HTML::Lazy](https://raku.online/modules/html-lazy/) | `rakupp install HTML::Lazy` |
| [`html-parser/`](html-parser/) | [HTML::Parser](https://raku.online/modules/html-parser/) | `rakupp install HTML::Parser` |
...
| [`lemmatize/`](lemmatize/) | [lemmatize](https://raku.online/modules/lemmatize/) | `rakupp install lemmatize` |
...
| [`lingua-en-conjugate/`](lingua-en-conjugate/) | [Lingua::EN::Conjugate](https://raku.online/modules/lingua-en-conjugate/) | `rakupp install Lingua::EN::Conjugate` |
| [`lingua-en-stopwords/`](lingua-en-stopwords/) | [Lingua::EN::Stopwords](https://raku.online/modules/lingua-en-stopwords/) | `rakupp install Lingua::EN::Stopwords` |
...
| [`lingua-lipogram/`](lingua-lipogram/) | [Lingua::Lipogram](https://raku.online/modules/lingua-lipogram/) | `rakupp install Lingua::Lipogram` |
...
| [`lingua-palindrome/`](lingua-palindrome/) | [Lingua::Palindrome](https://raku.online/modules/lingua-palindrome/) | `rakupp install Lingua::Palindrome` |
| [`lingua-pangram/`](lingua-pangram/) | [Lingua::Pangram](https://raku.online/modules/lingua-pangram/) | `rakupp install Lingua::Pangram` |
| [`lingua-stem-es/`](lingua-stem-es/) | [Lingua::Stem::Es](https://raku.online/modules/lingua-stem-es/) | `rakupp install Lingua::Stem::Es` |
| [`list-allmax/`](list-allmax/) | [List::Allmax](https://raku.online/modules/list-allmax/) | `rakupp install List::Allmax` |
| [`locale-dates/`](locale-dates/) | [Locale::Dates](https://raku.online/modules/locale-dates/) | `rakupp install Locale::Dates` |
| [`locale-us/`](locale-us/) | [Locale::US](https://raku.online/modules/locale-us/) | `rakupp install Locale::US` |
...
| [`lr1/`](lr1/) | [LR1](https://raku.online/modules/lr1/) | `rakupp install LR1` |
| [`lzw-revolunet/`](lzw-revolunet/) | [LZW::Revolunet](https://raku.online/modules/lzw-revolunet/) | `rakupp install LZW::Revolunet` |
| [`math-bijectivebase/`](math-bijectivebase/) | [Math::BijectiveBase](https://raku.online/modules/math-bijectivebase/) | `rakupp install Math::BijectiveBase` |
...
| [`math-fouriertransform/`](math-fouriertransform/) | [Math::FourierTransform](https://raku.online/modules/math-fouriertransform/) | `rakupp install Math::FourierTransform` |
| [`math-nearest/`](math-nearest/) | [Math::Nearest](https://raku.online/modules/math-nearest/) | `rakupp install Math::Nearest` |
| [`math-polynomial-chebyshev/`](math-polynomial-chebyshev/) | [Math::Polynomial::Chebyshev](https://raku.online/modules/math-polynomial-chebyshev/) | `rakupp install Math::Polynomial::Chebyshev` |
| [`math-random/`](math-random/) | [Math::Random](https://raku.online/modules/math-random/) | `rakupp install Math::Random` |
| [`math-selfdescriptivenumbers/`](math-selfdescriptivenumbers/) | [Math::SelfDescriptiveNumbers](https://raku.online/modules/math-selfdescriptivenumbers/) | `rakupp install Math::SelfDescriptiveNumbers` |
...
| [`math-zeckendorf/`](math-zeckendorf/) | [Math::Zeckendorf](https://raku.online/modules/math-zeckendorf/) | `rakupp install Math::Zeckendorf` |
| [`messagestream/`](messagestream/) | [MessageStream](https://raku.online/modules/messagestream/) | `rakupp install MessageStream` |
...
| [`ml-clustering/`](ml-clustering/) | [ML::Clustering](https://raku.online/modules/ml-clustering/) | `rakupp install ML::Clustering` |
| [`ml-rocfunctions/`](ml-rocfunctions/) | [ML::ROCFunctions](https://raku.online/modules/ml-rocfunctions/) | `rakupp install ML::ROCFunctions` |
| [`moonphase/`](moonphase/) | [Moonphase](https://raku.online/modules/moonphase/) | `rakupp install Moonphase` |
| [`mortgage/`](mortgage/) | [Mortgage](https://raku.online/modules/mortgage/) | `rakupp install Mortgage` |
...
| [`nativelibs/`](nativelibs/) | [NativeLibs](https://raku.online/modules/nativelibs/) | `rakupp install NativeLibs` |
| [`netstring/`](netstring/) | [Netstring](https://raku.online/modules/netstring/) | `rakupp install Netstring` |
| [`noise-simplex/`](noise-simplex/) | [Noise::Simplex](https://raku.online/modules/noise-simplex/) | `rakupp install Noise::Simplex` |
...
| [`numeric-nearest/`](numeric-nearest/) | [Numeric::Nearest](https://raku.online/modules/numeric-nearest/) | `rakupp install Numeric::Nearest` |
| [`object-container/`](object-container/) | [Object::Container](https://raku.online/modules/object-container/) | `rakupp install Object::Container` |
...
| [`operator-feq/`](operator-feq/) | [Operator::feq](https://raku.online/modules/operator-feq/) | `rakupp install Operator::feq` |
| [`p5chr/`](p5chr/) | [P5chr](https://raku.online/modules/p5chr/) | `rakupp install P5chr` |
...
| [`p5hex/`](p5hex/) | [P5hex](https://raku.online/modules/p5hex/) | `rakupp install P5hex` |
| [`p5index/`](p5index/) | [P5index](https://raku.online/modules/p5index/) | `rakupp install P5index` |
| [`p5lcfirst/`](p5lcfirst/) | [P5lcfirst](https://raku.online/modules/p5lcfirst/) | `rakupp install P5lcfirst` |
| [`p5length/`](p5length/) | [P5length](https://raku.online/modules/p5length/) | `rakupp install P5length` |
...
| [`p5reverse/`](p5reverse/) | [P5reverse](https://raku.online/modules/p5reverse/) | `rakupp install P5reverse` |
| [`package-updates/`](package-updates/) | [Package::Updates](https://raku.online/modules/package-updates/) | `rakupp install Package::Updates` |
| [`parameterizable/`](parameterizable/) | [Parameterizable](https://raku.online/modules/parameterizable/) | `rakupp install Parameterizable` |
| [`path-coverage/`](path-coverage/) | [path-coverage](https://raku.online/modules/path-coverage/) | `rakupp install path-coverage` |
...
| [`pod-tangle/`](pod-tangle/) | [Pod::Tangle](https://raku.online/modules/pod-tangle/) | `rakupp install Pod::Tangle` |
| [`proc-easy/`](proc-easy/) | [Proc::Easy](https://raku.online/modules/proc-easy/) | `rakupp install Proc::Easy` |
| [`prompt-gruff/`](prompt-gruff/) | [Prompt::Gruff](https://raku.online/modules/prompt-gruff/) | `rakupp install Prompt::Gruff` |
...
| [`scientist/`](scientist/) | [Scientist](https://raku.online/modules/scientist/) | `rakupp install Scientist` |
| [`serialise-map/`](serialise-map/) | [Serialise::Map](https://raku.online/modules/serialise-map/) | `rakupp install Serialise::Map` |
| [`shareable/`](shareable/) | [Shareable](https://raku.online/modules/shareable/) | `rakupp install Shareable` |
| [`shell-command/`](shell-command/) | [Shell::Command](https://raku.online/modules/shell-command/) | `rakupp install Shell::Command` |
| [`sort-naturally/`](sort-naturally/) | [Sort::Naturally](https://raku.online/modules/sort-naturally/) | `rakupp install Sort::Naturally` |
| [`sortuk/`](sortuk/) | [sortuk](https://raku.online/modules/sortuk/) | `rakupp install sortuk` |
...
| [`statistics-linearregression/`](statistics-linearregression/) | [Statistics::LinearRegression](https://raku.online/modules/statistics-linearregression/) | `rakupp install Statistics::LinearRegression` |
...
| [`sys-hostname/`](sys-hostname/) | [Sys::Hostname](https://raku.online/modules/sys-hostname/) | `rakupp install Sys::Hostname` |
| [`syslog-parse/`](syslog-parse/) | [Syslog::Parse](https://raku.online/modules/syslog-parse/) | `rakupp install Syslog::Parse` |
| [`system-query/`](system-query/) | [System::Query](https://raku.online/modules/system-query/) | `rakupp install System::Query` |
| [`tap/`](tap/) | [TAP](https://raku.online/modules/tap/) | `rakupp install TAP` |
| [`term-size/`](term-size/) | [Term::Size](https://raku.online/modules/term-size/) | `rakupp install Term::Size` |
...
| [`texas-to-uni/`](texas-to-uni/) | [Texas::To::Uni](https://raku.online/modules/texas-to-uni/) | `rakupp install Texas::To::Uni` |
...
| [`text-caesar/`](text-caesar/) | [Text::Caesar](https://raku.online/modules/text-caesar/) | `rakupp install Text::Caesar` |
...
| [`text-chart/`](text-chart/) | [Text::Chart](https://raku.online/modules/text-chart/) | `rakupp install Text::Chart` |
| [`text-diff-sift4/`](text-diff-sift4/) | [Text::Diff::Sift4](https://raku.online/modules/text-diff-sift4/) | `rakupp install Text::Diff::Sift4` |
| [`text-homoglyph/`](text-homoglyph/) | [Text::Homoglyph](https://raku.online/modules/text-homoglyph/) | `rakupp install Text::Homoglyph` |
| [`text-ldif/`](text-ldif/) | [Text::LDIF](https://raku.online/modules/text-ldif/) | `rakupp install Text::LDIF` |
...
| [`text-t9/`](text-t9/) | [Text::T9](https://raku.online/modules/text-t9/) | `rakupp install Text::T9` |
| [`text-upsidedown/`](text-upsidedown/) | [Text::UpsideDown](https://raku.online/modules/text-upsidedown/) | `rakupp install Text::UpsideDown` |
...
| [`timezones-us/`](timezones-us/) | [Timezones::US](https://raku.online/modules/timezones-us/) | `rakupp install Timezones::US` |
| [`tinyfloats/`](tinyfloats/) | [TinyFloats](https://raku.online/modules/tinyfloats/) | `rakupp install TinyFloats` |
| [`tinyid/`](tinyid/) | [TinyID](https://raku.online/modules/tinyid/) | `rakupp install TinyID` |
| [`today/`](today/) | [Today](https://raku.online/modules/today/) | `rakupp install Today` |
| [`trap/`](trap/) | [Trap](https://raku.online/modules/trap/) | `rakupp install Trap` |
| [`trigpi/`](trigpi/) | [TrigPi](https://raku.online/modules/trigpi/) | `rakupp install TrigPi` |
| [`uk-sort/`](uk-sort/) | [UK::Sort](https://raku.online/modules/uk-sort/) | `rakupp install UK::Sort` |
...
| [`wordfinder/`](wordfinder/) | [wordfinder](https://raku.online/modules/wordfinder/) | `rakupp install wordfinder` |
| [`x-intl/`](x-intl/) | [X::Intl](https://raku.online/modules/x-intl/) | `rakupp install X::Intl` |
...
| [`xml-entity-html/`](xml-entity-html/) | [XML::Entity::HTML](https://raku.online/modules/xml-entity-html/) | `rakupp install XML::Entity::HTML` |
| [`xml-query/`](xml-query/) | [XML::Query](https://raku.online/modules/xml-query/) | `rakupp install XML::Query` |
...
| [`zodiac-chinese/`](zodiac-chinese/) | [Zodiac::Chinese](https://raku.online/modules/zodiac-chinese/) | `rakupp install Zodiac::Chinese` |
