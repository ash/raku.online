...
www/              what gets published, verbatim
  ...
  tour/ spec/ grid/ map/ faq/ book/ modules/   generated by build.sh — do not edit by hand
  theme/
...
sites/            sources for the generated sub-sites
  ...
  ecosystem/        build.raku + src/, emits out/ — one Markdown file per module
                    under src/modules/, written here rather than synced.
                    Also writes examples/<module>/*.raku at the repo root

examples/         every module-page example as a runnable file — generated by
                  the ecosystem build, committed, and run by its --verify
...
The generated output under `www/tour`, `www/spec`, `www/faq`, `www/book` and
`www/ecosystem` **is committed**, so the
